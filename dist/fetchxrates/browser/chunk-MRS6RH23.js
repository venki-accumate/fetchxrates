...
function ContactComponent_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "form", 16, 0);
    \u0275\u0275listener("ngSubmit", function ContactComponent_Conditional_45_Template_form_ngSubmit_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSubmit());
    });
    \u0275\u0275elementStart(2, "div", 17)(3, "label", 18);
    \u0275\u0275text(4, "Name *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "input", 19);
    \u0275\u0275twoWayListener("ngModelChange", function ContactComponent_Conditional_45_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ContactComponent_Conditional_45_Template_input_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.formData.email, $event) || (ctx_r1.formData.email = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 17)(11, "label", 22);
    \u0275\u0275text(12, "Subject *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "input", 23);
    \u0275\u0275twoWayListener("ngModelChange", function ContactComponent_Conditional_45_Template_input_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.formData.subject, $event) || (ctx_r1.formData.subject = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 17)(15, "label", 24);
    \u0275\u0275text(16, "Message *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "textarea", 25);
    \u0275\u0275twoWayListener("ngModelChange", function ContactComponent_Conditional_45_Template_textarea_ngModelChange_17_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.formData.message, $event) || (ctx_r1.formData.message = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "app-button", 26);
    \u0275\u0275text(19, " Send Message ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const contactForm_r3 = \u0275\u0275reference(1);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.formData.name);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.formData.email);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.formData.subject);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.formData.message);
    \u0275\u0275advance();
    \u0275\u0275property("variant", "primary")("size", "lg")("disabled", !contactForm_r3.valid);
  }
}
function ContactComponent_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p");
    \u0275\u0275text(6, "Thank you for contacting us. We'll get back to you within 24 hours.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "app-button", 28);
    \u0275\u0275listener("click", function ContactComponent_Conditional_46_Template_app_button_click_7_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.submitted = false);
    });
  ...
  if (rf & 2) {
    \u0275\u0275advance(7);
    \u0275\u0275property("variant", "outline")("size", "md");
  }
}
var ContactComponent = class _ContactComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactComponent, selectors: [["app-contact"]], decls: 47, vars: 1, consts: [["contactForm", "ngForm"], [1, "contact-page"], [1, "hero"], [1, "container"], [1, "subtitle"], [1, "section"], [1, "contact-grid"], [1, "contact-info"], [1, "contact-methods"], [1, "contact-method"], [1, "method-icon"], ["href", "mailto:support@fetchxrates.com.au"], [1, "response-time"], [1, "contact-form-wrapper"], [1, "contact-form"], [1, "success-message"], [1, "contact-form", 3, "ngSubmit"], [1, "form-group"], ["for", "name"], ["type", "text", "id", "name", "name", "name", "required", "", "placeholder", "Your full name", 3, "ngModelChange", "ngModel"], ["for", "email"], ["type", "email", "id", "email", "name", "email", "required", "", "placeholder", "your.email@example.com", 3, "ngModelChange", "ngModel"], ["for", "subject"], ["type", "text", "id", "subject", "name", "subject", "required", "", "placeholder", "Brief description of your inquiry", 3, "ngModelChange", "ngModel"], ["for", "message"], ["id", "message", "name", "message", "required", "", "rows", "6", "placeholder", "Tell us more about your needs...", 3, "ngModelChange", "ngModel"], ["type", "submit", 2, "width", "100%", 3, "variant", "size", "disabled"], [1, "success-icon"], [3, "click", "variant", "size"]], template: function ContactComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(7, "section", 5)(8, "div", 3)(9, "div", 6)(10, "div", 7)(11, "h2");
      \u0275\u0275text(12, "Contact Information");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "p");
      \u0275\u0275text(14, "Choose your preferred way to reach us. We typically respond within 24 hours.");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(20, "Email");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "p")(22, "a", 11);
      \u0275\u0275text(23, "support@fetchxrates.com.au");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(24, "span", 12);
      \u0275\u0275text(25, "Response within 24 hours");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(31, "p");
      \u0275\u0275text(32, "For technical support and API questions");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "span", 12);
      \u0275\u0275text(34, "Paid plans: Priority support");
      \u0275\u0275elementEnd()();
    ...
    <div class="container">
      <div class="contact-grid">
        <div class="contact-info">
          ...
          <p>Choose your preferred way to reach us. We typically respond within 24 hours.</p>
          
          <div class="contact-methods">
            <div class="contact-method">
              <div class="method-icon">\u{1F4E7}</div>
              <h3>Email</h3>
              <p><a href="mailto:support@fetchxrates.com.au">support&#64;fetchxrates.com.au</a></p>
              <span class="response-time">Response within 24 hours</span>
            </div>

            <div class="contact-method">
              <div class="method-icon">\u{1F4AC}</div>
              <h3>Support</h3>
              <p>For technical support and API questions</p>
              <span class="response-time">Paid plans: Priority support</span>
            </div>

            <div class="contact-method">
              <div class="method-icon">\u{1F4CA}</div>
              <h3>Sales</h3>
              <p>For enterprise and custom solutions</p>
              <span class="response-time">Contact us for pricing</span>
            </div>
          </div>
        </div>
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-MRS6RH23.js.map
